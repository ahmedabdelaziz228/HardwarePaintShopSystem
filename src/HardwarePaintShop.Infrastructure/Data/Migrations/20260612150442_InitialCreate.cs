        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SyncLogs_SyncDevices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinStockBaseQuantity = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountScope = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnerWithdrawals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OwnerWithdrawals_Cashboxes_CashboxId",
                        column: x => x.CashboxId,
                        principalTable: "Cashboxes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnerWithdrawals_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraCosts = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierTransactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPurchasePriceBaseUnit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    AverageCostBaseUnit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConversionFactorToBase = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    SystemQuantityBase = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
                    ActualQuantityBase = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
                    DifferenceBase = table.Column<decimal>(type: "numeric", nullable: false),
                    Notes = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoicePayments_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSerials_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductSerials_PurchaseInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductSerials_SalesInvoices_SalesInvoiceId",
                        column: x => x.SalesInvoiceId,
                        principalTable: "SalesInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Returns_PurchaseInvoices_OriginalPurchaseInvoiceId",
                        column: x => x.OriginalPurchaseInvoiceId,
                        principalTable: "PurchaseInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Returns_SalesInvoices_OriginalSalesInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPrices_PriceGroups_PriceGroupId",
                        column: x => x.PriceGroupId,
                        principalTable: "PriceGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityBaseUnit = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
                    UnitPurchasePrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnItems_ProductUnits_ProductUnitId",
                        column: x => x.ProductUnitId,
                        principalTable: "ProductUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerTransactions_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicePayments_PaymentNo",
                table: "InvoicePayments",
                column: "PaymentNo",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicePayments_SupplierId",
                table: "InvoicePayments",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnerWithdrawals_CashboxId",
                table: "OwnerWithdrawals",
                column: "CashboxId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnerWithdrawals_UserId",
                table: "OwnerWithdrawals",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPrices_PriceGroupId",
                table: "ProductPrices",
                column: "PriceGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPrices_ProductUnitId_PriceGroupId",
                table: "ProductPrices",
                columns: new[] { "ProductUnitId", "PriceGroupId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSerials_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSerials_PurchaseInvoiceId",
                table: "ProductSerials",
                column: "PurchaseInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSerials_SalesInvoiceId",
                table: "ProductSerials",
                column: "SalesInvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnItems_ProductUnitId",
                table: "ReturnItems",
                column: "ProductUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Returns_OriginalPurchaseInvoiceId",
                table: "Returns",
                column: "OriginalPurchaseInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Returns_OriginalSalesInvoiceId",
                table: "Returns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncDevices_DeviceToken",
                table: "SyncDevices",
                column: "DeviceToken",
                unique: true);
